...
public class HomeController {
	...
	@Autowired
	private MessageSource messageSource; // properties 파일을 사용하기 위해서 필요.
	 ...
	 * 		└ arguments : .properties 파일 내 정의된 {0}, {1}, ... {n} 의 인자를 전달한다.
	 * 속성 - 예시 Hello.properties의 내용
	 * hello = {0}님 안녕하세요 ⓐ<spring:message code="hello" /> ⓑ<spring:message code="hello" arguments="kim" /> 
